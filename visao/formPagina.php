        ...
        <div class="box-body">
            <div class="row">
                <form action="<?= $action ?>" id="fpagina" name="fpagina" method="post">
                    ...
                    <div class="col-md-6">  
                        <div class="form-group">
                            <label for="iconepagina">Icone</label>
                            <input type='text' class="form-control" name="iconepagina" id="iconepagina" placeholder="Digite titulo" value="<?php if(isset($pagina["iconepagina"]) && $pagina["iconepagina"] != NULL && $pagina["iconepagina"] != ""){echo $pagina["iconepagina"];}?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <button class="btn btn-primary" onclick="salvarPagina()">Salvar</button>
